    ...
    <body>
        <script>
            ...
            function update(id) {
                ...
                xmlHttp2.open("GET", "get_title?id=" + id, true);
                //  xmlHttp.open("POST", "view_all?id="+id, true);
                xmlHttp2.send();
            ...
            function goupdate() {
                ...
                var tittle = document.getElementById("input-username").value;
                var id = document.getElementById("hvalue").value;
                console.log(tittle);
                console.log(id);
                let xmlHttp4;
                if (window.XMLHttpRequest) {
                ...
                xmlHttp4.onreadystatechange = function () {
                    if (xmlHttp4.readyState == 4 && xmlHttp4.status == 200) {
                       // var ar = JSON.parse(xmlHttp4.responseText);
                        window.location='add_department.jsp'


                    }
                }
                xmlHttp4.open("GET", "update_department?name=" + tittle + "&id=" + id, true);
                //  xmlHttp.open("POST", "view_all?id="+id, true);
                xmlHttp4.send();
            ...
            function save() {
                ...
                var tittle = document.getElementById("input-username").value;
                if(tittle===""){
                    winwindow.alert("Add Department Name");
                }
                let xmlHttp3;
                if (window.XMLHttpRequest) {
                ...
                xmlHttp3.onreadystatechange = function () {
                    if (xmlHttp3.readyState == 4 && xmlHttp3.status == 200) {
                       // var ar = JSON.parse(xmlHttp3.responseText);
                        window.alert("Department Registration Successfull");
                             window.location='add_department.jsp'


                    }
                }
                xmlHttp3.open("GET", "register_department?name=" + tittle, true);
                //  xmlHttp.open("POST", "view_all?id="+id, true);
                xmlHttp3.send();
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="input-username" class="form-control" placeholder="Enter Department Name" value="" name="dname">
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        <div class="col-4 text-right">
                                            ...
                                            <input type="submit" value="Register Department" class="btn btn-sm btn-primary" onclick="save()">
